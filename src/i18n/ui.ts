...
export const ui = {
  en: {
    ...
    'footer.links.notices': 'NOTICES & TERMS',
    'footer.links.disclaimers': 'DISCLAIMERS',
    ...
    'disclaimers.developer':
      'Palma Miami Beach (the "Condominium") is being developed, offered and sold by Palma Miami Beach, LLC, a Florida limited liability company (the "Developer") and not by Lefferts Investments LLC or its other affiliates ("Lefferts"). The Developer is a separate legal entity from Lefferts. Any and all statements, disclosures and/or representations shall be deemed made by Developer and not by Lefferts and you agree to look solely to the Developer (and not to Lefferts) with respect to any and all matters relating to the marketing and/or development of the Condominium and with respect to the sales of units in the Condominium.',
    ...
    'disclaimers.materials':
      'The sketches, renderings, graphic materials, plans, specifications, terms, conditions and statements contained herein are proposed only, and the Developer reserves the right to modify, revise or withdraw any or all of same in its sole discretion and without prior notice. They should not be relied upon as representations, express or implied, of the final detail of the residences or the Condominium. All stated dimensions and ceiling heights are approximate and all floor plans and development plans are subject to change. All residence features and finishes and building amenities are subject to change, including, without limitation, changes in manufacturers, brands, amenities, services and/or the design team. The views from units at the Condominium will vary depending on the unit purchased. Any view from any unit of from other portions of the property may in the future be limited or eliminated by future development or circumstances or events beyond our control, and the Developer in no manner guarantees the continuing existence of any view. Short term rental of units require each owner to obtain a certificate of use from the applicable governing agency and are otherwise subject to issuance at the discretion of the City of Miami Beach and applicable laws. While short term rentals are permitted as of the date hereof, there is no guarantee that this will always be the case. The project graphics, renderings and text provided herein are copyrighted works owned by the Developer. © 2023 Palma Miami Beach LLC or © 2023 Lefferts Investments LLC or their respective affiliates or licensors. All rights reserved. Unauthorized reproduction, display or other dissemination of such materials is strictly prohibited and constitutes copyright infringement. No real estate broker is authorized to make any representations or other statements regarding the Condominium, and no agreements with, deposits paid to or other arrangements made with any real estate broker are or shall be binding on the Developer.',
    ...
    'legal.photos.disclaimer':
      'The photographs contained in this Site may be stock photography or have been taken off-site and are used to depict the spirit of the lifestyles to be achieved rather than any that may exist or that may be proposed, and are merely intended as illustrations of the activities and concepts depicted therein. The floorplan designs, fixtures, furnishings, finishes, and décor depicted include creations and selections which may not be included with the purchase of a unit. There may be finishes are available to purchase as an upgrade to your unit. All residence features and building amenities are subject to change, including, without limitation, changes in manufacturers, brands, amenities, services and/or the design team. Consult your agreement and the offering documents for the items included with the units. Dimensions, ceiling heights and square footage are approximate and may vary with actual construction. Images and renderings are not to scale and are shown solely for illustrative purposes. Renderings depict proposed views, which are not identical from each unit. The views will vary depending on the unit purchased. No view is guaranteed. Any view from any unit of from other portions of the property may in the future be limited or eliminated by future development or circumstances or events beyond our control and the Developer in no manner guarantees the continuing existence of any view.',
    ...
    'legal.offsite.disclaimer':
      'Any and all references to and/or renderings of other proposed projects or nearby facilities depicted are proposed only, are not constructed, and are not being developed by the Developer. As such, the Developer has no control over those projects or facilities and there is no guarantee that they will be developed, or if so, when and what they will consist of. The information provided herein regarding other proposed projects or facilities depicted was obtained from newspaper articles and other public information and Developer makes no representations as to same. There is no guarantee that any or all such off-site attractions, shopping venues, restaurants, and activities will exist as depicted, or that there would not be changes or substitutions of the attractions and venues nearby',

    'legal.restaurants.disclaimer':
      'Any restaurants and other business establishments and/or any operators of same referenced on the Site are subject to change at any time, and no representations regarding restaurants, businesses and/or operators within the Project may be relied upon. Any such restaurants, and/or other business establishments would be operated from commercial components of the Project which may be offered for sale to third parties. Except as may be otherwise provided in the offering materials, the use of commercial spaces will be in discretion of the purchasers of those spaces and there is no assurance that they will be used for the purposes, and/or with the operators, named herein.',
    ...
    'legal.arbitration.title': 'Legal Disputes and Arbitration Agreement',
    ...
    'legal.indemnity.description':
      "You agree to indemnify and hold us, our subsidiaries, affiliates, and licensors (including specifically, but without limitation, Lefferts) and our and their respective officers, agents, partners and employees, harmless from any claims, damages, fines, losses, expenses, liability of any kind, including reasonable attorneys' fees, based upon, due to or arising out of your use of the Site or any Materials in violation of these Terms of Use or applicable law.",
    ...
    'legal.dmca.whatToDo': 'WHAT YOU MUST DO:',
    'legal.dmca.notification':
      'Written notification must be submitted to the following Designated Agent:',
    'legal.dmca.serviceProvider':
      'Service Provider: Palma Miami Beach LLC- www.palmamiamibeach.com',
    'legal.dmca.agent':
      'Name of Agent Designated to Receive Notification of Claimed Infringement: Palma Miami Beach LLC, Attn: Manager',
    'legal.dmca.address':
      'Full Address of Designated Agent to Which Notification Should be Sent: Palma Miami Beach LLC, 7134 Carlyle Avenue, Miami Beach, FL 33141, Attn: Manager',
    'legal.dmca.phone': 'Telephone Number of Designated Agent: +1 305.882.9942',
    'legal.dmca.email':
      'Email Address of Designated Agent: info@palmamiamibeach.com',
    'legal.dmca.include': 'WHAT YOUR NOTIFICATION MUST INCLUDE:',
    'legal.dmca.effective':
      'To be effective, the notification must include the following:',
    'legal.dmca.yourName':
      'Your name, physical address, telephone number, facsimile number, e-mail address and name of contact person;',
    'legal.dmca.identification':
      'Identification of the copyrighted work(s) claimed to have been infringed;',
    'legal.dmca.material':
      'Identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit us to locate the material;',
    'legal.dmca.goodFaith':
    ...
    'legal.dmca.notify':
      'We shall take reasonable steps to promptly notify the alleged infringer that we have removed or disabled access to the material.',
    'legal.dmca.counterResponse':
      'HOW THE ALLEGED INFRINGER CAN RESPOND TO US:',
    'legal.dmca.counterInclude':
      'The alleged infringer can respond by submitting a written counter notification to our Designated Agent. WHAT THE COUNTER NOTIFICATION MUST INCLUDE: To be effective, a counter notification from the alleged infringer must include the following:',
    'legal.dmca.counterName':
      "The alleged infringer's name, address, and telephone number;",
    'legal.dmca.counterConsent':
    ...
    'legal.dmca.counterIdentification':
      'Identification of the material that has been removed or to which access has been disabled and the location at which the material appeared before it was removed or access to it was disabled;',
    'legal.dmca.counterGoodFaith':
    ...
    'legal.questions.description':
      'Should you have any questions regarding the Site, or if you desire to contact us for any reason, please contact us at Palma Miami Beach LLC, 7134 Carlyle Avenue, Miami Beach, FL 33141, Attn: Manager, or by e-mail at info@palmamiamibeach.com or by phone at +1 305.882.9942, attention: Manager. We strive to make our Site content accessible and user-friendly. If you are having difficulty viewing the content on this Site or navigating the site, please call us at +1 305.882.9942 or email our team at info@palmamiamibeach.com, and we will be happy to assist you.',
    ...
    'legal.meta.title':
      'Legal Notices and Disclaimers & Website Terms of Use | Palma Miami Beach',
    'legal.meta.description':
      'Legal notices, disclaimers, and website terms of use for Palma Miami Beach luxury residences.',
    'legal.title': 'Legal Notices and Disclaimers & Website Terms of Use',
    'legal.subtitle': 'www.palmamiamibeach.com',

    'legal.acceptance':
      'YOUR USE OF THIS WEBSITE (the "Site") CONSTITUTES ACCEPTANCE OF THE TERMS AND CONDITIONS PROVIDED BELOW.',
    'legal.description':
      'These Website Terms of Use ("Terms of Use") describe the terms pursuant to which Palma Miami Beach LLC, a Florida limited liability company and/or an affiliated entity (referred to in these Terms of Use as the "Company," the "Developer," "we," "us" and "our") provides the website located at www.palmamiamibeach.com (the "Site"). We prepared these Terms of Use to help explain the terms that apply to your use of the Site. We may modify the Terms of Use as well as discontinue, withdraw, replace or change any content or services offered via the Site at any time and your continued access and use of the Site thereafter constitutes your acceptance of such changes. You may view the most up-to-date version of the Terms of Use at any time at [INSERT URL FOR WEBSITE TERMS]. These Terms of Use incorporate our Privacy Policy which explains and provides information regarding our collection, processing and use of personal information and your rights with respect thereto.',
    'legal.noAgreement':
      'If you do not agree to these Terms of Use, please do not use this Site.',

    'legal.notices.title': 'NOTICES AND DISCLAIMERS',
    'legal.notices.oral':
    ...
    'legal.copyright.description':
      "The Project graphics, renderings and text provided herein are copyrighted works owned by or licensed to the Developer or an affiliate thereof. © 2024 Palma Miami Beach LLC or © 2024 Lefferts Investments LLC, or their respective affiliates or licensors. All rights reserved. Unauthorized reproduction, display or other dissemination of such materials is strictly prohibited and constitutes copyright infringement. Please refer to the Developer's official Project brochures and materials and the documents furnished by the Developer pursuant to state law for information regarding the Project. The marks PALMA MIAMI BEACH℠ and LEFFERTS℠ are service marks of Lefferts. This Site may contain or reference trademarks, copyrighted materials or other intellectual property of the Developer and/or third parties. No license to or right in any such trademarks, copyrighted materials or other intellectual property of the Developer and/or third parties is granted to or conferred upon you. Nothing contained on this Site or in these Terms of Use serves to grant to you, by implication or otherwise, any license or right to use any trademarks or content displayed on this Site without the prior written permission of the Developer or its third party licensors, or such other third parties that may own the displayed trademarks or content. All rights not expressly granted herein are reserved. No interest or right to use the Project name or trademarks is acquired by purchasing any unit or interest in the Project.",
  ...
  es: {
    ...
    'footer.links.notices': 'AVISOS Y CONDICIONES',
    'footer.links.disclaimers': 'DESCARGOS DE RESPONSABILIDAD',
    ...
    'disclaimers.oralRepresentations':
      'NO SE PUEDE CONFIAR EN LAS DECLARACIONES ORALES COMO SI FUERAN DECLARACIONES CORRECTAS DEL PROMOTOR. PARA OBTENER DECLARACIONES CORRECTAS, CONSULTE ESTE FOLLETO Y LOS DOCUMENTOS EXIGIDOS POR LA SECCIÓN 718.503 DE LOS ESTATUTOS DE FLORIDA, QUE EL PROMOTOR DEBE PROPORCIONAR AL COMPRADOR O ARRENDATARIO.',
    'disclaimers.developer':
      'Palma Miami Beach (el "Condominio") está siendo desarrollado, ofrecido y vendido por Palma Miami Beach, LLC, una sociedad de responsabilidad limitada de Florida (el "Desarrollador") y no por Lefferts Investments LLC o sus otras afiliadas ("Lefferts"). El Desarrollador es una entidad legal separada de Lefferts. Todas y cada una de las declaraciones, divulgaciones y/o representaciones se considerarán hechas por el Desarrollador y no por Lefferts y usted acepta acudir únicamente al Desarrollador (y no a Lefferts) con respecto a todos y cada uno de los asuntos relacionados con la comercialización y/o desarrollo del Condominio y con respecto a las ventas de unidades en el Condominio.',
    'disclaimers.notAnOffer':
      'Esta oferta no pretende ser una oferta de venta ni una solicitud de compra de unidades de condominio a residentes de ninguna jurisdicción donde la ley lo prohíba, y su elegibilidad para la compra dependerá de su estado de residencia. Esta oferta se hace únicamente mediante el prospecto del condominio y no debe confiarse en ninguna declaración que no se haga en el prospecto.',
    'disclaimers.materials':
      'Los bocetos, representaciones, materiales gráficos, planos, especificaciones, términos, condiciones y declaraciones contenidos en el presente documento son sólo propuestas, y el Promotor se reserva el derecho de modificar, revisar o retirar cualquiera o todos ellos a su entera discreción y sin previo aviso. No se debe confiar en ellos como representaciones, expresas o implícitas, del detalle final de las residencias o del Condominio. Todas las dimensiones y alturas de techo indicadas son aproximadas y todos los planos de planta y planos de desarrollo están sujetos a cambios. Todas las características y acabados de las residencias y los servicios del edificio están sujetos a cambios, incluidos, entre otros, los cambios de fabricantes, marcas, servicios, servicios y/o el equipo de diseño. Las vistas desde las unidades del Condominio variarán según la unidad adquirida. Cualquier vista desde cualquier unidad de otras partes de la propiedad puede en el futuro ser limitada o eliminada por el desarrollo futuro o circunstancias o eventos fuera de nuestro control, y el Desarrollador de ninguna manera garantiza la existencia continua de cualquier vista. El alquiler a corto plazo de las unidades requiere que cada propietario obtenga un certificado de uso de la agencia gubernamental aplicable y están sujetos a la emisión a discreción de la Ciudad de Miami Beach y las leyes aplicables. Si bien los alquileres a corto plazo están permitidos a partir de la fecha del presente documento, no hay garantía de que este será siempre el caso. Los gráficos del proyecto, las representaciones y el texto proporcionados en este documento son obras protegidas por derechos de autor propiedad del Promotor. 2023 Palma Miami Beach LLC o © 2023 Lefferts Investments LLC, o sus respectivas filiales o licenciantes. Todos los derechos reservados. La reproducción, exhibición u otro tipo de difusión no autorizada de dichos materiales está estrictamente prohibida y constituye una infracción de los derechos de autor. Ningún corredor de bienes raíces está autorizado para hacer representaciones u otras declaraciones con respecto al Condominio, y ningún acuerdo con, depósitos pagados a u otros arreglos hechos con cualquier corredor de bienes raíces son o serán vinculantes para el Desarrollador.',
